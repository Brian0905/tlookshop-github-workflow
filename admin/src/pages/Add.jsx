    ...
    <div className='w-full pb-10'>
      <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='w-full'>
          ...
          <input onChange={(e) => setName(e.target.value)} value={name} className='w-full max-w-[500px] px-3 py-2 border border-gray-300' type="text" placeholder='Nhập tên sản phẩm' required />
        </div>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8 mt-4'>
          ...
          <div>
            ...
            <input onChange={(e) => setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px] border border-gray-300' type="Number" placeholder='...đ' />
          </div>
